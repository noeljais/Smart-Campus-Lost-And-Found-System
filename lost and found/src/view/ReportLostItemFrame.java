...
/**
 * Frame for reporting lost items
 */
public class ReportLostItemFrame extends JFrame {
    ...
    public ReportLostItemFrame(AuthController authController) {
    ...
    private JPanel createHeaderPanel() {
        ...
        JLabel subtitleLabel = new JLabel("Help us find your lost item");
    ...
    private JPanel createFormPanel() {
        ...
        selectImageButton.setBackground(new Color(67, 97, 238));
    ...
    private JPanel createButtonPanel() {
        ...
        submitButton.setBackground(new Color(234, 67, 53));
    ...
    private void handleSubmit() {
        ...
        String result = itemController.reportLostItem(userId, itemName, description, imageData, contact);
